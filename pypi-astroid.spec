...
Source0  : https://files.pythonhosted.org/packages/94/02/aa9c9ca14e8e6aad685953726ce273da130ca82835a63404ddefd710dd3a/astroid-2.15.1.tar.gz
...
%prep
%setup -q -n astroid-2.15.1
cd %{_builddir}/astroid-2.15.1
pushd ..
cp -a astroid-2.15.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679937392
