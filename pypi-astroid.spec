...
Source0  : https://files.pythonhosted.org/packages/00/c2/9b2de9ed027f9fe5734a6c0c0a601289d796b3caaf1e372e23fa88a73047/astroid-3.3.10.tar.gz
...
%prep
%setup -q -n astroid-3.3.10
cd %{_builddir}/astroid-3.3.10
pushd ..
cp -a astroid-3.3.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747066732
