...
Source0  : https://files.pythonhosted.org/packages/9e/53/1067e1113ecaf58312357f2cd93063674924119d80d173adc3f6f2387aa2/astroid-3.2.4.tar.gz
...
%prep
%setup -q -n astroid-3.2.4
cd %{_builddir}/astroid-3.2.4
pushd ..
cp -a astroid-3.2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721661696
