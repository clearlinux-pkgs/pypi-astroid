...
Version  : 2.14.0
Release  : 177
URL      : https://files.pythonhosted.org/packages/16/1a/3f7c9444ea09736f892fa6e4f9e0892f0d772390986a9c59e9fbfbe436a8/astroid-2.14.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/16/1a/3f7c9444ea09736f892fa6e4f9e0892f0d772390986a9c59e9fbfbe436a8/astroid-2.14.0.tar.gz
...
%prep
%setup -q -n astroid-2.14.0
cd %{_builddir}/astroid-2.14.0
pushd ..
cp -a astroid-2.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675182545
