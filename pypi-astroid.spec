...
Source0  : https://files.pythonhosted.org/packages/a9/d5/e2ed69df4dc6a707f1dfe00fb15c128f94a279bab2fbbdefb7185d313190/astroid-2.11.4.tar.gz
...
%prep
%setup -q -n astroid-2.11.4
cd %{_builddir}/astroid-2.11.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651521513
...
cp %{_builddir}/astroid-2.11.4/LICENSE %{buildroot}/usr/share/package-licenses/pypi-astroid/83baf0020e7e2a77169bbf1111f5f9fcb418abca
