...
Version  : 2.12.1
Release  : 155
URL      : https://files.pythonhosted.org/packages/92/d6/9b402f4b33e5292ff2c579d11127ac71ace22da575a1e46e95ab4d994766/astroid-2.12.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/92/d6/9b402f4b33e5292ff2c579d11127ac71ace22da575a1e46e95ab4d994766/astroid-2.12.1.tar.gz
...
%prep
%setup -q -n astroid-2.12.1
cd %{_builddir}/astroid-2.12.1
pushd ..
cp -a astroid-2.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657478165
...
cp %{_builddir}/astroid-2.12.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-astroid/83baf0020e7e2a77169bbf1111f5f9fcb418abca
