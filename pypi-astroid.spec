...
Source0  : https://files.pythonhosted.org/packages/38/1e/326fb1d3d83a3bb77c9f9be29d31f2901e35acb94b0605c3f2e5085047f9/astroid-3.3.5.tar.gz
...
%prep
%setup -q -n astroid-3.3.5
cd %{_builddir}/astroid-3.3.5
pushd ..
cp -a astroid-3.3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728426656
