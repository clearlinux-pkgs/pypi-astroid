...
Version  : 2.12.2
Release  : 158
URL      : https://files.pythonhosted.org/packages/85/bf/683c6321dfd8f15535bc72874bb60ee502175c0a5fcec94df3233d62c794/astroid-2.12.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/85/bf/683c6321dfd8f15535bc72874bb60ee502175c0a5fcec94df3233d62c794/astroid-2.12.2.tar.gz
...
%prep
%setup -q -n astroid-2.12.2
cd %{_builddir}/astroid-2.12.2
pushd ..
cp -a astroid-2.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657637171
...
cp %{_builddir}/astroid-2.12.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-astroid/83baf0020e7e2a77169bbf1111f5f9fcb418abca
