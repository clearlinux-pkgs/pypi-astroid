...
Source0  : https://files.pythonhosted.org/packages/ad/cb/b6c1645e359ed639350a7b68be68fc279ea0f60dfdd075b622614e168159/astroid-2.12.10.tar.gz
...
%prep
%setup -q -n astroid-2.12.10
cd %{_builddir}/astroid-2.12.10
pushd ..
cp -a astroid-2.12.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663599900
