...
Source0  : https://files.pythonhosted.org/packages/d4/a8/0b849573a58ba1d2f96e8a91e2ece9daced5fadcfc990d2d473b86814be3/astroid-2.12.9.tar.gz
...
%prep
%setup -q -n astroid-2.12.9
cd %{_builddir}/astroid-2.12.9
pushd ..
cp -a astroid-2.12.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662567658
