...
Version  : 3.2.3
Release  : 201
URL      : https://files.pythonhosted.org/packages/96/77/a503a7bc6246b53f54305bce8aae6c474b3d2291dae00bb1b0226cfe4096/astroid-3.2.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/96/77/a503a7bc6246b53f54305bce8aae6c474b3d2291dae00bb1b0226cfe4096/astroid-3.2.3.tar.gz
...
%prep
%setup -q -n astroid-3.2.3
cd %{_builddir}/astroid-3.2.3
pushd ..
cp -a astroid-3.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720799029
