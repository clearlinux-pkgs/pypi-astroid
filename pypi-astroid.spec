...
Source0  : https://files.pythonhosted.org/packages/6d/1e/b6f6065acb262dd1f7466d23626ea1c7bf033c0675294c41cf96deb86d3a/astroid-2.14.1.tar.gz
...
%prep
%setup -q -n astroid-2.14.1
cd %{_builddir}/astroid-2.14.1
pushd ..
cp -a astroid-2.14.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675266769
