...
Version  : 2.12.5
Release  : 162
URL      : https://files.pythonhosted.org/packages/71/fe/d5322dc78073508c839a80fd35752c65be45af6c62d4e883b7681105785a/astroid-2.12.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/71/fe/d5322dc78073508c839a80fd35752c65be45af6c62d4e883b7681105785a/astroid-2.12.5.tar.gz
...
%prep
%setup -q -n astroid-2.12.5
cd %{_builddir}/astroid-2.12.5
pushd ..
cp -a astroid-2.12.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661792073
