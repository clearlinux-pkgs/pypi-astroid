...
Source0  : https://files.pythonhosted.org/packages/39/33/536530122a22a7504b159bccaf30a1f76aa19d23028bd8b5009eb9b2efea/astroid-3.3.9.tar.gz
...
%prep
%setup -q -n astroid-3.3.9
cd %{_builddir}/astroid-3.3.9
pushd ..
cp -a astroid-3.3.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742838314
