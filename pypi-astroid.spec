...
Source0  : https://files.pythonhosted.org/packages/a9/b9/f11533eed9b65606fb02f1b0994d8ed0903358bc55a6b9759e42f1134725/astroid-3.1.0.tar.gz
...
%prep
%setup -q -n astroid-3.1.0
cd %{_builddir}/astroid-3.1.0
pushd ..
cp -a astroid-3.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708967024
