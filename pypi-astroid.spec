...
Source0  : https://files.pythonhosted.org/packages/60/73/6a30d506ac5317b8b8db2a4340172a85a9b545e7fb732f390c1d2a35d8de/astroid-2.15.0.tar.gz
...
%prep
%setup -q -n astroid-2.15.0
cd %{_builddir}/astroid-2.15.0
pushd ..
cp -a astroid-2.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678117924
