...
Source0  : https://files.pythonhosted.org/packages/c2/49/5dd5f36b2cd2b315d45023ed4e2d6f1ba57d054ea9a1378f91f093ec57bb/astroid-2.13.2.tar.gz
...
%prep
%setup -q -n astroid-2.13.2
cd %{_builddir}/astroid-2.13.2
pushd ..
cp -a astroid-2.13.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673280594
