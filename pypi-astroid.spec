...
Source0  : https://files.pythonhosted.org/packages/f0/53/abbf8ce4f5cff1763aec6f5d7b8e0b2284f2ce9401b660fd4187bcb1ff57/astroid-2.12.4.tar.gz
...
%prep
%setup -q -n astroid-2.12.4
cd %{_builddir}/astroid-2.12.4
pushd ..
cp -a astroid-2.12.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661444473
