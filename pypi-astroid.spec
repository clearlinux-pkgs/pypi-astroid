...
Source0  : https://files.pythonhosted.org/packages/b6/e8/f86aa1fd91b7fa5b51ed53c9a06a94dba7cc388b51cb712e8721c41605ef/astroid-3.2.0.tar.gz
...
%prep
%setup -q -n astroid-3.2.0
cd %{_builddir}/astroid-3.2.0
pushd ..
cp -a astroid-3.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715094647
