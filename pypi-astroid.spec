...
Source0  : https://files.pythonhosted.org/packages/98/c8/e1de5f7dd1ff87c2dd9fce3e7e0dd5605946cdc480bdf70cf95d5bbbfd45/astroid-2.11.3.tar.gz
...
%prep
%setup -q -n astroid-2.11.3
cd %{_builddir}/astroid-2.11.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650413120
...
cp %{_builddir}/astroid-2.11.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-astroid/83baf0020e7e2a77169bbf1111f5f9fcb418abca
