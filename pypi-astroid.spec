...
Source0  : https://files.pythonhosted.org/packages/32/1d/242aac28594e49755f994e19386ffcb34805e1e0198a72af77cce9a2bfcf/astroid-2.11.1.tar.gz
...
%prep
%setup -q -n astroid-2.11.1
cd %{_builddir}/astroid-2.11.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648147859
...
cp %{_builddir}/astroid-2.11.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-astroid/83baf0020e7e2a77169bbf1111f5f9fcb418abca
